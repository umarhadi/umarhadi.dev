"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6179],{6179:function(e,t,i){i.r(t),i.d(t,{default:function(){return C}});var r=i(11527),n=i(60367),o=i(86692);var s=o.ZP.nav.withConfig({componentId:"sc-e840bc6c-0"})`
  display: flex;
...
`;var I=o.ZP.span.withConfig({componentId:"sc-a718d402-0"})`
  ...
  width: 100%;
  z-index: -1;
`;var T=()=>{const{sizes:{startMenu:e}}=(0,o.Fg)(),t=Math.min(e.maxHeight,(0,z.sI)()-$.bK);return{animate:"active",exit:"initial",initial:"initial",transition:{duration:$.Nb.START_MENU,ease:"circOut"},variants:{active:{height:`${t}px`,paddingTop:0},initial:{height:.75*t+"px",paddingTop:.5*t+"px"}}}};var C=e=>{let{toggleStartMenu:t}=e;const i=(0,l.useRef)(null),[o,s]=(0,l.useState)(!1),a=T(),{height:h}=a.variants?.active??{};return(0,l.useLayoutEffect)((()=>i.current?.focus($.eS)),[]),(0,r.jsxs)(y,{ref:i,$showScrolling:o,onBlurCapture:e=>{let{relatedTarget:r}=e;const n=r;if(!(n&&i.current?.contains(n))){const e=n===i.current?.nextSibling,r=n?.parentElement===i.current?.nextSibling;e||r?i.current?.focus($.eS):t(!1)}},onMouseMove:e=>{let{clientX:t=0}=e;const{width:r=0}=i.current?.getBoundingClientRect()||{};s(t>r-$.BQ)},...a,...$.LL,children:[(0,r.jsx)(I,{$height:h}),(0,r.jsx)(k,{height:h}),(0,r.jsx)(n.Z,{url:`${$.Sd}/Start Menu`,view:"list",hideLoading:!0,hideShortcutIcons:!0,loadIconsImmediately:!0,preloadShortcuts:!0,readOnly:!0,skipFsWatcher:!0,skipSorting:!0,useNewFolderIcon:!0})]})}}}]);