"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5868],{38295:function(e,t,r){var n=r(11527),i=r(67398),o=r(15455),a=r(14304),l=r.n(a),s=r(50959);const c=l()((()=>r.e(4039).then(r.bind(r,34039))),{loadableGenerated:{webpack:()=>[34039]}});t.Z=e=>{let{id:t,useHook:r,StyledComponent:a,children:l}=e;const{processes:{[t]:{url:d=""}={}}}=(0,o.z)(),b=(0,s.useRef)(null),[g,u]=(0,s.useState)(!0),h=(0,s.useMemo)((()=>({contain:"strict",visibility:g?"hidden":"visible"})),[g]);return r(t,d,b,u,g),(0,n.jsxs)(n.Fragment,{children:[g&&(0,n.jsx)(c,{}),(0,n.jsx)(a,{ref:b,style:h,...(0,i.Z)({id:t}),children:l})]})}},95868:function(e,t,r){r.r(t),r.d(t,{default:function(){return j}});var n=r(11527),i=r(38295);const o=()=>(0,n.jsx)("svg",{viewBox:"0 0 32 32",xmlns:"http://www.w3.org/2000/svg",children:(0,n.jsx)("path",{d:"M32 15v2H17v15h-2V17H0v-2h15V0h2v15h15z"})}),a=()=>(0,n.jsx)("svg",{viewBox:"0 0 32 32",xmlns:"http://www.w3.org/2000/svg",children:(0,n.jsx)("path",{d:"M32 17H0v-2h32v2z"})}),l=()=>(0,n.jsx)("svg",{viewBox:"0 0 32 32",xmlns:"http://www.w3.org/2000/svg",children:(0,n.jsx)("path",{d:"M6 32v-2h18v2H6zm18.703-15.297L15 26.484l-9.703-9.781 1.406-1.406L14 22.641V0h2v22.641l7.297-7.344z"})}),s=()=>(0,n.jsx)("svg",{viewBox:"0 0 32 32",xmlns:"http://www.w3.org/2000/svg",children:(0,n.jsx)("path",{d:"M30 12q0.406 0 0.773 0.156t0.641 0.43 0.43 0.641 0.156 0.773v14h-8v4h-16v-4h-8v-14q0-0.406 0.156-0.773t0.43-0.641 0.641-0.43 0.773-0.156h6v-12h16v12h6zM10 12h12v-10h-12v10zM22 22h-12v8h12v-8zM30 14h-28v12h6v-6h16v6h6v-12zM5 16q0.406 0 0.703 0.297t0.297 0.703-0.297 0.703-0.703 0.297-0.703-0.297-0.297-0.703 0.297-0.703 0.703-0.297z"})});var c=r(74965);var d=c.ZP.nav.withConfig({componentId:"sc-8d1911a-0"})`
...
`;var j=e=>{let{id:t}=e;return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(i.Z,{StyledComponent:$,id:t,useHook:v,children:(0,n.jsx)("ol",{id:"pages"})}),(0,n.jsx)(f,{id:t})]})}},67398:function(e,t,r){var n=r(2832),i=r(45761),o=r(8082),a=r(74479),l=r(15455),s=r(7211),c=r(82296),d=r(50959),b=r(95063),g=r(63270);t.Z=e=>{let{callback:t,directory:r=b.Ll,id:u,onDragLeave:h,onDragOver:p,updatePositions:m}=e;const{url:x}=(0,l.z)(),{iconPositions:A,sortOrders:v,setIconPositions:w}=(0,s.k)(),{mkdirRecursive:f,updateFolder:k,writeFile:$}=(0,a.o)(),j=(0,d.useCallback)((async(e,t,r)=>{if(u)if(t){const n=(0,c.join)(b.Ll,e);await f(b.Ll),await $(n,t,!0)&&(r===o.v.UPDATE_URL&&x(u,n),k(b.Ll,e))}else r===o.v.UPDATE_URL&&x(u,e)}),[u,f,k,x,$]),{openTransferDialog:y}=(0,n.Z)();return{onDragLeave:h,onDragOver:e=>{p?.(e),(0,g.nK)(e)},onDrop:e=>{if(m&&e.target instanceof HTMLElement){const{files:t,text:n}=(0,i.p4)(e);if(0===t.length&&""===n)return;const o={x:e.clientX,y:e.clientY};let a=[];if(n){try{a=JSON.parse(n)}catch{}if(!Array.isArray(a))return;const[e]=a;if(!e)return;if(e.startsWith(r)&&(0,c.basename)(e)===(0,c.relative)(r,e))return;a=a.map((e=>(0,c.basename)(e)))}else a=t instanceof FileList?[...t].map((e=>e.name)):[...t].map((e=>e.getAsFile()?.name||"")).filter(Boolean);a=a.map((e=>{if(!A[`${r}/${e}`])return e;let t=0,n="";do{t+=1,n=`${r}/${(0,c.basename)(e,(0,c.extname)(e))} (${t})${(0,c.extname)(e)}`}while(A[n]);return(0,c.basename)(n)})),(0,g.vi)(r,e.target,A,v,o,a,w)}(0,i.WG)(e,t||j,r,y,Boolean(u))}}}},92588:function(e,t,r){var n=r(15455),i=r(86870),o=r(50959),a=r(95063);t.Z=e=>{const{title:t}=(0,n.z)(),[r]=e.split(a.CC),{title:l}=i.Z[r]||{};return{appendFileToTitle:(0,o.useCallback)(((r,n)=>{const i=r?` - ${r}${n?` ${a.xy}`:""}`:"";t(e,`${l}${i}`)}),[e,l,t]),prependFileToTitle:(0,o.useCallback)(((r,n)=>{const i=r?`${n?`${a.xy} `:""}${r} - `:"";t(e,`${i}${l}`)}),[e,l,t])}}},73317:function(e,t,r){r.d(t,{Z:function(){return c}});var n=r(74965);const i="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAKElEQVR42mOgMRgF6enp/ynSDMMUaEZgsjST5RJsikk2AKc4bcAoAADI7y5FsB5j/QAAAABJRU5ErkJggg==",o="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAK0lEQVR42mOgARgF6enp/0kRZ8KvGMEnyQUwjMwn0xBMzWQZQlmA0h6MAgAuqCnfdOk/ZQAAAABJRU5ErkJggg==",a="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAG0lEQVR42mPAD0ZBenr6fxge4ppHuiGEwSgAAGJiLkXUVlYDAAAAAElFTkSuQmCC",l="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAG0lEQVR42mPADkZBenr6fxgeZoYMV82Ug1EAAPiTLkWjutmQAAAAAElFTkSuQmCC",s={dark:{active:"rgb(166, 166, 166)",blendMode:"color-burn",buttonHover:"rgb(55, 55, 55)",thumb:"rgb(77, 77, 77)",thumbHover:"rgb(122, 122, 122)",track:"rgb(23, 23, 23)"},light:{active:"rgb(96, 96, 96)",blendMode:"color-dodge",buttonHover:"rgb(218, 218, 218)",thumb:"rgb(205, 205, 205)",thumbHover:"rgb(166, 166, 166)",track:"rgb(240, 240, 240)"}};var c=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,c=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"dark";return n.iv`
  overflow: auto;
