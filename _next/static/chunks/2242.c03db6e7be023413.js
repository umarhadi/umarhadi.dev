...
`,s=r(10047),l=r(9297),c=r(31266),p=r(32652),u=r(81030),d=r(64037),f=r(735),m=r(50959),h=r(71059),g=r(46429),w=r(80830),y=r(22519);const b="open",x={cmd:"Terminal",code:"MonacoEditor",dos:"JSDOS",explorer:"FileExplorer",monaco:"MonacoEditor",mspaint:"Paint",vlc:"VideoPlayer"},v=`Type the name of a program, folder, document, or Internet resource, and ${h.PACKAGE_DATA.alias} will open it for you.`,k=e=>alert(`Cannot find '${e}'. Make sure you typed the name correctly, and then try again.`),$={esheep:y.default,sheep:y.default};var C=()=>{const{open:e,closeWithTransition:t,processes:{Run:r}={}}=(0,p.z)(),{createPath:y,exists:C,readFile:P,stat:S,updateFolder:j}=(0,c.o)(),{foregroundId:L,runHistory:D,setRunHistory:E}=(0,d.k)(),R=(0,m.useRef)(null),[F,T]=(0,m.useState)(!0),[_,I]=(0,m.useState)(!D[0]),[M,A]=(0,m.useState)(!1),O=(0,m.useCallback)((async r=>{if(!r)return;A(!0);const n=()=>E((e=>e[0]===r?e:[r,...e])),[i,...a]=(0,o.$4)(r);let l=r,c=!0;const p=await C(l);p||(l=a.length>0?a.join(" "):i);const d=l.startsWith("ipfs://");if(p||d||await C(l)){if(d)try{const e=await(0,w.getIpfsResource)(l);l=(0,f.join)(h.Ll,await y(await(0,w.getIpfsFileName)(l,e),h.Ll,e)),j(h.Ll,(0,f.basename)(l))}catch{}if((await S(l)).isDirectory())e("FileExplorer",{url:l},""),n();else if(i&&a.length>0&&l!==r){const t=Object.keys(u.Z).find((e=>e.toLowerCase()===i.toLowerCase()));t?(e(t,{url:"Browser"===t&&d?a.join(" "):l}),n()):(k(i),c=!1)}else{const t=(0,g.RT)(l);if(t===h.zm){const{pid:t,url:r}=(0,s.OE)(await P(l));t&&e(t,{url:r})}else{const n=(0,s.Wd)(t);n&&e(n,{url:"Browser"===n&&d?r:l})}n()}}else{const t=Object.keys(u.Z).find((e=>e.toLowerCase()===(x[l.toLowerCase()]||l).toLowerCase()));t?(e(t),n()):$[r.toLowerCase()]?($[r.toLowerCase()](),n()):(k(r),c=!1)}A(!1),c&&t("Run")}),[t,y,C,e,P,E,S,j]);return(0,m.useLayoutEffect)((()=>{"Run"===L&&(R.current?.focus(h.eS),R.current?.value&&R.current?.select())}),[L]),(0,m.useLayoutEffect)((()=>{r?.url&&R.current&&(R.current.value=`${R.current.value.trimEnd()} ${r.url}`.trim(),I(!1))}),[r?.url]),(0,n.jsxs)(a,{...(0,l.Z)({id:"Run"}),onContextMenu:e=>{e.target instanceof HTMLInputElement||(0,g.nK)(e)},children:[(0,n.jsxs)("figure",{children:[(0,n.jsx)("img",{alt:"Run",src:"/System/Icons/32x32/run.webp"}),(0,n.jsx)("figcaption",{children:v})]}),(0,n.jsxs)("div",{children:[(0,n.jsx)("label",{htmlFor:b,children:"Open:"}),(0,n.jsxs)("div",{children:[(0,n.jsx)("input",{ref:R,autoComplete:"off",defaultValue:D[0],disabled:M,enterKeyHint:"go",id:b,onBlurCapture:e=>{let{relatedTarget:t}=e;!r?.componentWindow||r.componentWindow.contains(t)?R.current?.focus(h.eS):T(!1)},onFocusCapture:()=>T(!0),onKeyDownCapture:e=>{const{key:r}=e;"Enter"===r&&O(R.current?.value.trim()),"Escape"===r&&((0,g.nK)(e),t("Run"))},onKeyUp:e=>{let{target:t}=e;return I(!t?.value)},spellCheck:"false",type:"text"}),(0,n.jsx)("select",{disabled:0===D.length,onChange:e=>{let{target:t}=e;R.current&&(R.current.value=t.value,I(!1))},onClick:e=>{let{target:t}=e;t instanceof HTMLSelectElement&&-1!==t.selectedIndex&&(t.selectedIndex=-1)},children:D.map(((e,t)=>(0,n.jsx)("option",{value:e,children:e},`${e}-${t}`)))})]})]}),(0,n.jsxs)("nav",{children:[(0,n.jsx)(i.Z,{className:F?"focus":"",disabled:_||M,onClick:()=>O(R.current?.value.trim()),children:"OK"}),(0,n.jsx)(i.Z,{disabled:M,onClick:()=>t("Run"),children:"Cancel"})]})]})}},4214:function(e,t,r){const n=r(6444).ZP.button.withConfig({componentId:"sc-6268283d-0"})`
